...
export type CustomEventHandlerReturnType = void | boolean | ((socket: Socket) => void);

export type CustomEventHandlerType = (params: ICustomEventHandlerParams) => CustomEventHandlerReturnType;

export type CustomEventHandlerPayloadEchoType = (payload: any, getSockets?: () => Promise<Array<Socket> | Socket>) => void;
